...
export class XlsxStyleExtractor extends XlsxBaseExtractor {
  ...
  getFonts(): XLSXFont[] {
    return this.mapOnElements({ document: this.rootFile.file, query: "font" }, (font): XLSXFont => {
  ...
  private extractFont(fontElement: Element): XLSXFont {
    ...
    // The behaviour for these is kinda strange. The text is italic if there is either a "italic" tag with no "val"
  ...
  getFills(): XLSXFill[] {
    return this.mapOnElements(
      { document: this.rootFile.file, query: "fill" },
  ...
  getBorders(): XLSXBorder[] {
    return this.mapOnElements(
      { document: this.rootFile.file, query: "border" },
  ...
  private extractAlignement(alignmentElement: Element): XLSXCellAlignement {
    return {
  ...
  getDxfs(): XLSXDxf[] {
    return this.mapOnElements(
      { query: "dxf", document: this.rootFile.file },
      (dxfElement): XLSXDxf => {
        ...
        return {
          ...
          alignment: alignmentElement ? this.extractAlignement(alignmentElement) : undefined,
  ...
  getStyles(): XLSXStyle[] {
    return this.mapOnElements(
      { query: "cellXfs xf", document: this.rootFile.file },
