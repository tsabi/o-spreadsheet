...
describe("Resizer component", () => {
  ...
  test("Double click: Modify the size of a row", async () => {
    ...
    expect(model.getters.getRow(model.getters.getActiveSheetId(), 1)!.size).toBe(30);
    setCellContent(model, "B2", "b2");
    await dblClickRow(1);
    expect(model.getters.getRow(model.getters.getActiveSheetId(), 1)!.size).toBe(
      DEFAULT_CELL_HEIGHT
  ...
  test("Select 123 5, dblclick 5 then resize all", async () => {
    ...
    expect(model.getters.getRow(model.getters.getActiveSheetId(), 3)!.size).toBe(30);
    expect(model.getters.getRow(model.getters.getActiveSheetId(), 4)!.size).toBe(
      DEFAULT_CELL_HEIGHT
    );
  });
  ...
  test("Select 123 5, dblclick 6 then resize only 6", async () => {
    ...
    await selectRow(4, { ctrlKey: true });
    await dblClickRow(5);
    expect(model.getters.getRow(model.getters.getActiveSheetId(), 0)!.size).toBe(30);
    expect(model.getters.getRow(model.getters.getActiveSheetId(), 1)!.size).toBe(30);
    expect(model.getters.getRow(model.getters.getActiveSheetId(), 2)!.size).toBe(30);
    expect(model.getters.getRow(model.getters.getActiveSheetId(), 3)!.size).toBe(30);
    expect(model.getters.getRow(model.getters.getActiveSheetId(), 4)!.size).toBe(30);
    expect(model.getters.getRow(model.getters.getActiveSheetId(), 5)!.size).toBe(
      DEFAULT_CELL_HEIGHT
    );
  });
