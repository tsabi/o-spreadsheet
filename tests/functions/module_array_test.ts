...
describe("array", () => {
  ...
  test("GROWTH: fonctional tests on range", () => {
    // prettier-ignore
    const grid = {
      A1: "23", B1: "1", C1: "6",  
      A2: "25", B2: "2", C2: "7", 
      ...
      F1: "=GROWTH(A1:A9)", 
      G1: "=GROWTH(A1:A9, B1:B9)",
      H1: "=GROWTH(A1:A9, C1:C9)", 
      K1: "=GROWTH(A1:A9, B1:C9)", 
  
      A13: "=GROWTH(A1:A9, B1:B8)",
  
      F11: "2", G11: "=GROWTH(A1:A9, B1:B9, F11)", 
      F12: "2", G12: "=GROWTH(A1:A9, B1:B9, F11, 0)", 
      F13: "2", G13: "=GROWTH(A1:A9, B1:B9, F11, FALSE)", 
      F14: "2", G14: "=GROWTH(A1:A9, B1:B9, F11, 1)", 
      F15: "2", G15: "=GROWTH(A1:A9, B1:B9, F11, 2)", 
      ...
      A22: "=GROWTH(A18:A20)",
      A26: "=GROWTH(A18:B20)", 
      D26: "=GROWTH(A18:B20, D18:E20)",
      G26: "=GROWTH(A18:B20, G18:H20)",

      J26: "=GROWTH(A18:B20, D18:D20)",
      ...
      E33: "1",  G33: "=GROWTH(E33:E44)", I33: "1",  K33: "=GROWTH(I33:I44)", 
      E34: "2",                          I34: "4",   
      E35: "5",                          I35: "7",   
      E36: "5",                          I36: "2",   
      E37: "4",                          I37: "5",  
      ...
      E50: "1", G50: "=GROWTH(E50:E55)", I50: "1", K50: "=GROWTH(I50:I55)", 
      E51: "2",                         I51: "4",  
      E52: "4",                         I52: "7",  
      E53: "5",                         I53: "2",  
      E54: "7",                         I54: "5",  
      ...
      K61: "=GROWTH(A58:I58, A59:H59)", 
  
      A63: "=GROWTH(A58:I58)",
      A64: "=GROWTH(A58:I58, A59:I59)", 
      A65: "=GROWTH(A58:I58, A60:I60)", 

      A68: "=GROWTH(A58:I58, A59:I60)", 
  
      // -------------------------------------------------------------------------
  
      B71: "6",  C71: "45",  D71: "3100", E71: "=GROWTH(D71:D82, B71:C82)",
      ...
      B83: "7",  C83: "47",               E83: "=GROWTH(D71:D82, B71:C82, B83:C86)",
      B84: "8",  C84: "58",               
      B85: "8",  C85: "59",               
      B86: "9",  C86: "62",               
    };
    ...
    expect(evaluatedGrid.F1).toBeCloseTo(24.21, 1);
    expect(evaluatedGrid.G1).toBeCloseTo(24.21, 1);
    expect(evaluatedGrid.H1).toBeCloseTo(23.85, 1);
    expect(evaluatedGrid.K1).toBeCloseTo(23.53, 1);

    expect(evaluatedGrid.A13).toBe("#ERROR");

    expect(evaluatedGrid.G11).toBeCloseTo(25.26, 1);
    expect(evaluatedGrid.G12).toBeCloseTo(2.93, 1);
    expect(evaluatedGrid.G13).toBeCloseTo(2.93, 1);
    expect(evaluatedGrid.G14).toBeCloseTo(25.26, 1);
    expect(evaluatedGrid.G15).toBeCloseTo(25.26, 1);

    expect(evaluatedGrid.A22).toBeCloseTo(4.41, 1);
    expect(evaluatedGrid.A26).toBeCloseTo(4.3, 1);
    expect(evaluatedGrid.D26).toBeCloseTo(4.3, 1);
    expect(evaluatedGrid.G26).toBeCloseTo(4.65, 1);

    expect(evaluatedGrid.J26).toBe("#ERROR");

    expect(evaluatedGrid.A38).toBeCloseTo(2.0, 1);
    expect(evaluatedGrid.G33).toBeCloseTo(2.0, 1);
    expect(evaluatedGrid.K33).toBeCloseTo(2.44, 1);

    expect(evaluatedGrid.A53).toBeCloseTo(1.29, 1);
    expect(evaluatedGrid.G50).toBeCloseTo(1.29, 1);
    expect(evaluatedGrid.K50).toBeCloseTo(1.79, 1);

    expect(evaluatedGrid.K61).toBe("#ERROR");

    expect(evaluatedGrid.A63).toBeCloseTo(24.21, 1);
    expect(evaluatedGrid.A64).toBeCloseTo(24.21, 1);
    expect(evaluatedGrid.A65).toBeCloseTo(23.85, 1);
    expect(evaluatedGrid.A68).toBeCloseTo(23.53, 1);

    expect(evaluatedGrid.E71).toBeCloseTo(3110.76, 1);
    expect(evaluatedGrid.E83).toBeCloseTo(3385.63, 1);
  });
