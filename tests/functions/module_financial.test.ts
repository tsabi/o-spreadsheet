...
describe("ACCRINT function", () => {
  test("ACCRINT takes 4-7 arguments", () => {
    expect(evaluateCell("A1", { A1: "=ACCRINT()" })).toBe("#BAD_EXPR"); // @compatibility: on google sheets, return #N/A
    expect(evaluateCell("A1", { A1: "=ACCRINT(0)" })).toBe("#BAD_EXPR"); // @compatibility: on google sheets, return #N/A
    expect(evaluateCell("A1", { A1: "=ACCRINT(0, 0)" })).toBe("#BAD_EXPR"); // @compatibility: on google sheets, return #N/A
    expect(evaluateCell("A1", { A1: "=ACCRINT(0, 0, 1)" })).toBe("#BAD_EXPR"); // @compatibility: on google sheets, return #N/A
    expect(evaluateCell("A1", { A1: "=ACCRINT(0, 0, 1, 1)" })).toBe(0);
    expect(evaluateCell("A1", { A1: "=ACCRINT(0, 0, 1, 1, 1)" })).toBe(0);
    expect(evaluateCell("A1", { A1: "=ACCRINT(0, 0, 1, 1, 1, 1)" })).toBe(0);
    expect(evaluateCell("A1", { A1: "=ACCRINT(0, 0, 1, 1, 1, 1, 0)" })).toBe(0);
    expect(evaluateCell("A1", { A1: "=ACCRINT(0, 0, 1, 1, 1, 1, 0, 0)" })).toBe("#BAD_EXPR"); // @compatibility: on google sheets, return #N/A
  });

  test.each([
    ["01/01/2004", "01/01/2005", "01/01/2006", "5.00%", 1000, 1, 0, 100],
    ["01/01/2005", "01/01/2005", "06/06/2006", "12.00%", 1000, 2, 0, 171.666666666667],
    ["03/12/2004", "01/01/2005", "02/28/2012", "0.50%", 1000, 4, 0, 39.8055555555556],
    ["02/29/2020", "01/01/2005", "01/03/2022", "1.00%", 68, 4, 0, 1.25422222222222],
    ["01/01/2004", "01/01/2005", "01/01/2006", "5.00%", 1000, 1, 0, 100],
    ["01/01/2005", "01/01/2005", "06/06/2006", "12.00%", 1000, 2, 0, 171.666666666667],
    ["01/01/2004", "01/01/2005", "02/28/2012", "0.50%", 1000, 4, 0, 40.7916666666667],
    ["01/01/2022", "01/01/2005", "01/03/2022", "1.00%", 68, 4, 0, 0.00377777777777778],
    ["01/01/2004", "01/01/2005", "05/01/2004", "5.00%", 12, 2, 0, 0.2],
    ["01/01/2004", "01/01/2005", "01/01/2006", "1.00%", 1, 1, 0, 0.02],
    ["01/01/2004", "01/01/2005", "01/01/2006", "5.00%", 5, 2, 0, 0.5],
    ["01/01/2004", "01/01/2005", "06/01/2006", "1.00%", 110, 2, 0, 2.65833333333333],
    ["01/01/2005", "01/01/2005", "12/31/2005", "5.00%", 1000, 4, 0, 50],
    ["01/01/2005", "01/01/2005", "12/31/2005", "5.00%", 1000, 4, 1, 49.8630136986301],
    ["01/01/2005", "01/01/2005", "12/31/2005", "5.00%", 1000, 4, 2, 50.5555555555556],
    ["01/01/2005", "01/01/2005", "12/31/2005", "5.00%", 1000, 4, 3, 49.8630136986301],
    ["01/01/2005", "01/01/2005", "12/31/2005", "5.00%", 1000, 4, 4, 50],
    ["02/29/2004", "01/01/2005", "01/01/2007", "5.00%", 1000, 4, 0, 141.944444444444],
    ["02/29/2004", "01/01/2005", "01/01/2007", "5.00%", 1000, 4, 1, 141.666666666667],
    ["02/29/2004", "01/01/2005", "01/01/2007", "5.00%", 1000, 4, 2, 144.027777777778],
    ["02/29/2004", "01/01/2005", "01/01/2007", "5.00%", 1000, 4, 3, 142.054794520548],
    ["02/29/2004", "01/01/2005", "01/01/2007", "5.00%", 1000, 4, 4, 141.944444444444],
    ["01/01/2002", "01/01/2005", "02/28/2007", "5.00%", 1000, 4, 0, 257.916666666667],
    ["01/01/2002", "01/01/2005", "02/28/2007", "5.00%", 1000, 2, 1, 258.082191780822],
    ["01/01/2002", "01/01/2005", "02/28/2007", "5.00%", 1000, 2, 2, 261.666666666667],
    ["01/01/2002", "01/01/2005", "02/28/2007", "5.00%", 1000, 2, 3, 258.082191780822],
    ["01/01/2002", "01/01/2005", "02/28/2007", "5.00%", 1000, 2, 4, 257.916666666667],
  ])(
    "Libroffice CALC function result =ACCRINT(%s, %s, %s, %s, %s, %s, %s)",
    (
      arg0: string,
      arg1: string,
      arg2: string,
      ...
      const cellValue = evaluateCell("A1", {
        A1: `=ACCRINT("${arg0}", "${arg1}", "${arg2}", ${arg3}, ${arg4}, ${arg5}, ${arg6})`,
      });
  ...
  test.each([
    ["01/01/2004", "01/01/2005", "01/01/2006", "5.00%", 1000, 2, 0, 100],
    ["01/01/2005", "01/01/2005", "06/06/2006", "12.00%", 1000, 2, 0, 171.6666667],
    ["03/12/2004", "01/01/2005", "02/28/2012", "0.50%", 1000, 4, 0, 39.80555556],
    ["02/29/2020", "01/01/2005", "01/03/2022", "1.00%", 68, 4, 0, 1.252333333],
    ["01/01/2004", "01/01/2005", "01/01/2006", "5.00%", 1000, 1, 0, 100],
    ["01/01/2005", "01/01/2005", "06/06/2006", "12.00%", 1000, 2, 0, 171.6666667],
    ["01/01/2004", "01/01/2005", "02/28/2012", "0.50%", 1000, 4, 0, 40.79166667],
    ["01/01/2022", "01/01/2005", "01/03/2022", "1.00%", 68, 4, 0, 0.003777778],
    ["01/01/2004", "01/01/2005", "05/01/2004", "5.00%", 12, 2, 0, 0.2],
    ["01/01/2004", "01/01/2005", "01/01/2006", "1.00%", 1, 1, 0, 0.02],
    ["01/01/2004", "01/01/2005", "01/01/2006", "5.00%", 5, 2, 0, 0.5],
    ["01/01/2004", "01/01/2005", "06/01/2006", "1.00%", 110, 2, 0, 2.658333333],
    ["01/01/2005", "01/01/2005", "12/31/2005", "5.00%", 1000, 4, 0, 50],
    ["01/01/2005", "01/01/2005", "12/31/2005", "5.00%", 1000, 4, 1, 49.86413043],
    ["01/01/2005", "01/01/2005", "12/31/2005", "5.00%", 1000, 4, 2, 50.13888889],
    ["01/01/2005", "01/01/2005", "12/31/2005", "5.00%", 1000, 4, 3, 49.96575342],
    ["01/01/2005", "01/01/2005", "12/31/2005", "5.00%", 1000, 4, 4, 49.86111111],
    ["02/29/2004", "01/01/2005", "01/01/2007", "5.00%", 1000, 4, 0, 141.8055556],
    ["02/29/2004", "01/01/2005", "01/01/2007", "5.00%", 1000, 4, 1, 141.8956044],
    ["02/29/2004", "01/01/2005", "01/01/2007", "5.00%", 1000, 4, 2, 142.2222222],
    ["02/29/2004", "01/01/2005", "01/01/2007", "5.00%", 1000, 4, 3, 141.9863014],
    ["02/29/2004", "01/01/2005", "01/01/2007", "5.00%", 1000, 4, 4, 141.9444444],
    ["01/01/2002", "01/01/2005", "02/28/2007", "5.00%", 1000, 4, 0, 257.9166667],
    ["01/01/2002", "01/01/2005", "02/28/2007", "5.00%", 1000, 4, 1, 257.8804348],
    ["01/01/2002", "01/01/2005", "02/28/2007", "5.00%", 1000, 4, 2, 258.0555556],
    ["01/01/2002", "01/01/2005", "02/28/2007", "5.00%", 1000, 4, 3, 257.9452055],
    ["01/01/2002", "01/01/2005", "02/28/2007", "5.00%", 1000, 4, 4, 257.9166667],
  ])(
    "function result =ACCRINT(%s, %s, %s, %s, %s, %s, %s)",
    (
      arg0: string,
      arg1: string,
      arg2: string,
...
describe("EFFECT formula", () => {
  ...
  test("Nominal rate is > 0 and <= 1", () => {
    ...
    expect(evaluateCell("A1", { A1: "=EFFECT(2, 1)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
  });
...
describe("NOMINAL formula", () => {
  ...
  test("Effective rate is > 0 and <= 1", () => {
    ...
    expect(evaluateCell("A1", { A1: "=NOMINAL(2, 1)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
  });
...
describe("PRICEDISC function", () => {
  ...
  test.each([
    ...
    ["01/01/2012", "01/01/2013", "5%", 100, 0, 95],
    ["01/01/2012", "01/01/2013", "5%", 100, 1, 95],
    ["01/01/2012", "01/01/2013", "5%", 100, 2, 94.91666667],
    ["01/01/2012", "01/01/2013", "5%", 100, 3, 94.98630137],
    ["01/01/2012", "01/01/2013", "5%", 100, 4, 95],
    ["01/01/2012", "02/28/2012", "5%", 100, 0, 99.20833333],
    ["01/01/2012", "02/28/2012", "5%", 100, 1, 99.20765027],
    ["01/01/2012", "02/28/2012", "5%", 100, 2, 99.19444444],
    ["01/01/2012", "02/28/2012", "5%", 100, 3, 99.20547945],
    ["01/01/2012", "02/28/2012", "5%", 100, 4, 99.20833333],
  ])(
...
describe("YIELDDISC function", () => {
  ...
  test.each([
    ...
    ["12/20/2014", "05/01/2016", 50, 68, 1, 0.264096386],
    ["12/20/2014", "05/01/2016", 50, 12, 1, -0.557536814],
    ...
    ["01/01/2012", "05/01/2016", 20, 12, 1, -0.092389381],
