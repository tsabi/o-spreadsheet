...
describe("LOOKUP formula", () => {
  test("functional tests on range", () => {
    ...
    expect(evaluatedGrid.A13).toBe("#N/A"); // @compatibility: on googlesheets, return #NUM!
    expect(evaluatedGrid.A14).toBe("#N/A"); // @compatibility: on googlesheets, return #NUM!
